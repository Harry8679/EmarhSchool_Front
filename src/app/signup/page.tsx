                ...
                <div className="max-w-[400px] w-full p-6 bg-white dark:bg-slate-900 shadow-md shadow-slate-100 dark:shadow-slate-800 rounded-md">
                    ...
                    <form className="text-start">
                        <div className="grid grid-cols-1">
                            <div className="mb-4">
                                <label className="font-semibold" htmlFor="RegisterName">Votre nom :</label>
                                <input id="RegisterName" type="text" className="w-full py-2 px-3 border border-slate-100 dark:border-slate-800 focus:border-violet-600/30 dark:focus:border-violet-600/30 bg-transparent focus:outline-none rounded-md h-10 mt-3" placeholder="MacCode"/>
                            </div>

                            <div className="mb-4">
                                <label className="font-semibold" htmlFor="RegisterName">Votre prénom :</label>
                            ...
                            <div className="mb-4">
                                <div className="flex items-center mb-0">
                                    ...
                                    <label className="form-check-label text-slate-400" htmlFor="AcceptT&C">J'accepte <Link href="" className="text-violet-600">les Termes les Conditions</Link></label>
                                </div>
                            </div>

                            <div className="mb-4">
                                <Link href="" className="h-10 px-5 tracking-wide inline-flex items-center justify-center font-medium rounded-md bg-violet-600 text-white w-full">Inscription</Link>
                            </div>
